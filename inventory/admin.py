...
from .models import InventoryItem, Location, Project, InventoryLog, UIDCategorySequence, InventoryDocument, ItemCategory,DocumentTag,ItemStatus
...
class InventoryDocumentAdmin(admin.ModelAdmin):
    list_display = ['tag', 'file', 'inventory_item', 'uploaded_by', 'uploaded_at']
    list_filter = ['tag', 'uploaded_at', 'uploaded_by']
    search_fields = ['inventory_item__item_name', 'inventory_item__uid_no', 'uploaded_by__username']
    autocomplete_fields = ['inventory_item', 'uploaded_by']

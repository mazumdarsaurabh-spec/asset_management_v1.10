...
import os
os.environ["GEMINI_API_KEY"] = "AIzaSyD3VjZQwabFKgBzSfu8T9P15YkSdRUM78U"
...
LOGGING = {
    ...
    'loggers': {
        # The empty string logger ('') acts as the root logger, applying to all loggers
        '': {
            'handlers': ['console'],
            'level': 'INFO',
        },
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(DB_DIR,'db_storage','db.sqlite3'),
    }
}
